...
const HomePageComp = () => {
  ...
  return (
    <div>
      <ProjectLayoutComp>
        <div className='tw-bg-[#323331]'>
          <div className='tw-relative tw-mx-auto tw-max-w-screen-xl tw-pt-4'>
            <div className='tw-mx-auto tw-max-w-screen-xl tw-transition-all tw-duration-300 tw-ease-in-out'>
              <div className='tw-mx-3 tw-flex tw-scroll-my-10 tw-justify-between lg:tw-mx-0'>
                ...
                <div className='tw-mt-2 tw-flex tw-items-center tw-justify-center'>
                  ...
                  <div className='tw-flex tw-flex-col'>
                    ...
                    <h2 className='-tw-mt-2 tw-text-xs tw-font-semibold tw-text-white'>
                      Debtor Monitoring Agency
                    </h2>
                    <h4 className='-tw-mt-2 tw-text-[9px] tw-text-white'>
                      For Schools
                    </h4>
                  </div>
                </div>
                ...
                <div className='tw-hidden tw-items-center tw-justify-center tw-space-x-10 lg:tw-flex '>
                  <NavLink
                    to='/'
                    className='tw-cursor-pointer tw-font-fam1  tw-text-white tw-no-underline tw-transition-all tw-duration-300 tw-ease-in-out '
                    style={({ isActive }) =>
                  ...
                  <NavLink
                    className='tw-font-fam1 tw-text-white tw-no-underline tw-transition-all '
                    to='/about'
                    style={({ isActive }) =>
                      isActive ? activeStyle : undefined
                    }
                ...
                <div className='tw-hidden tw-items-center tw-justify-center tw-space-x-4 tw-font-fam1 lg:tw-flex '>
                  <NavLink
                    className='tw-w-fit tw-rounded-lg tw-border tw-border-white tw-bg-transparent tw-py-2 tw-px-10 tw-text-white tw-no-underline tw-transition-all tw-duration-300 tw-ease-in-out hover:tw-bg-blue-100'
                    to='/signin'
              ...
              Register
                ...
                <div className='tw-flex tw-items-center tw-justify-center lg:tw-hidden'>
                  <div
                    onClick={handleShow}
                    className='tw-w-fit  tw-cursor-pointer tw-rounded-full tw-border-0 tw-bg-transparent tw-p-3 tw-text-white
          tw-transition-all tw-duration-500 tw-ease-in-out'
                  >
                    <RiMenu5Fill className='tw-text-[22px] tw-text-white' />
                  </div>
                </div>
              </div>
            </div>
 ...
 * <div className='tm_slider slide'>
                    <div className='slider_element'>
                      <div className='col_logo sl_logo_1'></div>
                      <div className='col te_text'>
                        <h3 className='slider_title'>Bridgerton High School</h3>
                        <p className='s_para'>
                          ‘DMA is a welcome development in the school mode of
                          operation as it has fostered credit worthiness in
                          parents/guardians
                        </p>
                      </div>
                    </div>
