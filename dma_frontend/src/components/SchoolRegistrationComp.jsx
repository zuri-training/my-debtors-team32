    ...
    <div>
      ...
      <main>
        <form className='Reg-form'>
          ...
          <br />
          <input type="text" className="reg-description" name="description" required="" />
          <br /><br />
          ...
          <br />
          <input type="text" className="reg-schaddress" name="school" required="" />
          <br /><br />
          <label htmlFor="reg-contact">Contact Number</label>
          <br />
          <input type="number" className="reg-contact" name="contact" required="" />
          <br /><br />
          ...
          <div className='reg-doc'>
            ...
            <div>
              <p
                >The certificate for schools <br /><br />
                School registration certificate <br /><br />
          ...
          <div className="reg-title">
            <label htmlFor="sel-doc">Title</label><br />
            <select name="sch-cert" id="sch-certificate">
              <option value="The certificate for schools">The certificate for schools</option>
              <option value="School registration certificate">School registration certificate</option>
              <option value="Approval by ministry of education">Approval by ministry of education</option>
            </select>
            <br /><br />
            <br /><br />
            <label htmlFor="myregdoc">Attact Document</label>
            <input type="file" id="myregdoc" name="myfile" multiple /><br /><br />
          </div>
